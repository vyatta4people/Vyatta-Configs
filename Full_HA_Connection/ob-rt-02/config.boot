...
interfaces {
    ethernet eth0 {
        address 3.3.3.202/24
        description WAN(Mugabe)
        duplex auto
        firewall {
            in {
                name WAN_in
        ...
        speed auto
        traffic-policy {
            in Limiter4WAN_Mugabe
            out Shaper4WAN_Mugabe
        }
    }
    ethernet eth1 {
        address 4.4.4.202/24
        description WAN(Zulu)
        duplex auto
        firewall {
            in {
                name WAN_in
    ...
    dhcp-server {
        ...
        shared-network-name LAN {
            ...
            subnet 10.0.200.0/24 {
                ...
                domain-name officeb.snakevenom.com
                lease 86400
                ntp-server 10.0.200.254
                start 10.0.200.101 {
                    stop 10.0.200.200
                }
            }
...
traffic-policy {
    limiter Limiter4WAN_Mugabe {
        default {
            bandwidth 15mbit
            burst 15k
        }
        description "WAN inbound QoS policy (Mugabe)"
    }
    limiter Limiter4WAN_Zulu {
        default {
            bandwidth 10mbit
            burst 15k
        }
        description "WAN inbound QoS policy (Zulu)"
    }
    shaper Shaper4LAN {
        bandwidth 1000mbit
        class 100 {
    ...
    shaper Shaper4WAN_Mugabe {
        ...
        description "WAN outbound QoS policy (Mugabe)"
    }
    shaper Shaper4WAN_Zulu {
        bandwidth 1mbit
        class 100 {
            bandwidth 45%
            burst 15k
        ...
        description "WAN outbound QoS policy (Zulu)"
    }
}
